    ...
    <main class="main-content">
        <header class="main-header">
            <div class="header-title">
                ...
                <p class="subtitle">أدخل بيانات الطالب ثم احفظ.</p>
            </div>
        ...
        <section style="max-width:720px;">
            @if ($errors->any())
                <div class="alert" style="background:#fdecec;border:1px solid #f5c2c7;color:#b02a37;padding:10px;border-radius:10px;margin-bottom:12px">
            ...
            <form method="POST" action="{{ route('user_admin.students.store') }}" class="card-form" style="display:grid;gap:12px">
                @csrf
                <div>
                    <label>الاسم</label>
                ...
                <div>
                    ...
                    <input name="national_id" class="input">
                </div>
                <div>
                    <label>الصف</label>
                    <input name="grade" class="input" placeholder="مثال: السابع">
                </div>
                <div>
                    <label>الحالة</label>
