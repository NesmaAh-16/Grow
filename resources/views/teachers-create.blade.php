        ...
        <main class="main-content">
            <header class="main-header">
                <div class="header-title">
                    ...
                    <p class="subtitle">أدخل بيانات المعلم ثم احفظ.</p>
                </div>
            ...
            <section style="max-width:720px;">
                @if (session('ok'))
                    <div class="alert"
                        style="background:#e6ffed;border:1px solid #b4f8c8;padding:10px;border-radius:10px;color:#1a7f37;margin-bottom:12px">
                        {{ session('ok') }}
                    </div>
                @endif
                @if ($errors->any())
                ...
                <form method="POST" action="{{ route('user_admin.teachers.store') }}" class="card-form"
                    ...
                    <div>
                        ...
                        <input name="national_id" class="input" required>
                    </div>

                    <div>
                        <label>التخصص</label>
                        <input name="specialty" class="input" placeholder="مثال: الرياضيات" required>
                    </div>
